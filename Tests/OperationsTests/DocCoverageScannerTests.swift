...
/// synthetic fixtures, independent of the real source tree — proves the
/// scanner itself catches every declaration kind `DocCoverageTests` relies on
/// it to check, and doesn't false-positive on already-documented or
/// non-public code.
